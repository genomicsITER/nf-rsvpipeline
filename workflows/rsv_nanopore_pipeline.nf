...
include { PREPROCESSING_PIPELINE } from '../subworkflows/local/nanopore/preprocessing'

include { ALIGN as ALIGN_RSVA    } from '../subworkflows/local/nanopore/align'
include { ALIGN as ALIGN_RSVB    } from '../subworkflows/local/nanopore/align'
...
include { CALLING_AND_CONSENSUS as CALLING_AND_CONSENSUS_RSVA } from '../subworkflows/local/nanopore/calling_and_consensus'
include { CALLING_AND_CONSENSUS as CALLING_AND_CONSENSUS_RSVB } from '../subworkflows/local/nanopore/calling_and_consensus'
...
workflow RSV_NANOPORE_PIPELINE {

    ch_versions = Channel.empty()
    ch_multiqc_files = Channel.empty()

    fastq_exp = params.indir + "/*.fastq.gz"
    ...
    //
    // MODULE: Basecalling QC with pycoQC
    //
    if (params.sequencing_summary) {
        ch_sequencing_summary = Channel
            .fromPath (params.sequencing_summary)
            .map { [ [id:"pycoqc_results"], it ] }
