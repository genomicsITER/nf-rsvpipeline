process PLOT_MOSDEPTH_REGIONS {
    ...
    """
    # Generate heatmap plot of the coverage per amplicon using this script from Viralrecon pipeline:
    # https://raw.githubusercontent.com/nf-core/viralrecon/master/bin/plot_mosdepth_regions.r
